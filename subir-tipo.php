...
$marca = new Marca();
$listado = $db->getRows(array(),'tipo_componente');
?>
    ...
    <div class = "container">
       <div class="tableHeaderContainer">
           ...
           <div class="search-container">
               ...
               <input class="search" type="text" id="mySearch" placeholder="Buscar">
           </div>
            
       </div>
            
        <table id="marcaTable" data-table-name="tipo_componente">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nombre</th>
            ...
            <tbody id="userData">
               <?php
                if(is_array($listado) && !empty($listado)) {
